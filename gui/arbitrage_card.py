...
try:
    ...
    from PyQt5.QtWidgets import QCheckBox, QComboBox, QFrame, QHBoxLayout, QLabel, QPushButton, QVBoxLayout, QWidget
...
if QFrame is not object:
    class ArbitrageCard(QFrame):
        ...
        def apply_state(self, state: CardState) -> None:
            ...
            self.body_container.setVisible(not state.collapsed)
